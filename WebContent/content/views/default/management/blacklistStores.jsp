				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							店家黑名单<a href="javascript:void(0);" onclick="popupwindow('management/addShopBlackList');"><span class="badge navbar-right" id="yunfei"><font size="3px;">添加&nbsp;&nbsp;+</font></span></a>
						</h3>
					</div>
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="blacklist" items="${list }" varStatus="pool">
									...
									<td><button class="btn btn-default" onclick="popupwindow('management/addBlack?id=${blacklist.id}&mathed=update');">修改原因</button>
