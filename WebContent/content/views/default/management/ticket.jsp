		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<li><a href="javascript:void(0);"><font style="font-size: 18px;">其它</font></a></li>
					<span class="divider"><font style="font-size: 18px;">/</font></span>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							票的类型<a href="javascript:void(0);" onclick="popupwindow('management/addTicket');"><span class="badge navbar-right" id="yunfei"><font size="3px;">添加&nbsp;&nbsp;+</font></span></a>
						</h3>
					</div>
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="ticket" items="${list }" varStatus="pool">
									...
									<td><button class="btn btn-default" onclick="popupwindow('management/updateTicket?id=${ticket.brandID}');">修改名称</button>
