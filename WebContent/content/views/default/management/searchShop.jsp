...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form class="form-horizontal" action="management/searchShop" method="POST">
							...
							<tbody>
								<c:forEach var="shop" items="${list }" varStatus="pool">
									<c:if test="${shop.blacklist == null }">
										...
										<td>
											<button onclick="popupwindow('management/addBlack?id=${shop.id}&mathed=add&page=shop');">加入黑名单</button></td>
										</tr>
									</c:if>
								</c:forEach>
							</tbody>
