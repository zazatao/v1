...
<ul>
	<c:forEach var="cur" items="${list}" varStatus="vs">  
	 ...
	 <li><span><i class="icon-minus-sign"></i>${cur.category }</span><a href="javascript:void(0);" onclick="onclickID('${cur.categoryID}');">&nbsp;&nbsp;<img title="操作" src="../content/static/img/banshou.png"></a>
		  <c:if test="${fn:length(cur.children) > 0}"><!-- 如果有childen -->  
		    ...
		    <c:import url="__shopCategory.jsp" /><!-- 这就是递归了 -->  
		  </c:if>
	  </li>  
	</c:forEach> 
</ul>  
