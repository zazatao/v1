...
<body>
			...
			<div class="col-md-12 column">
				<form class="form-horizontal"  id="form" name="form" method="POST">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea rows="3" cols="1000" name="reasons"></textarea>
						</div>
					</div>
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10" style="text-align: center;">
							<button type="button" class="btn btn-default" onclick="add();">加入黑名单</button>
						</div>
					</div>
				</form>
			</div>
	...
	<script type="text/javascript">
		...
		function add(){
			document.form.action="./addBlacklistForShop?id=${id}";
