...
<body>
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<form class="form-horizontal" action="management/searchGoods" method="POST">
							...
							<tbody>
								<c:forEach var="comm" items="${list }" varStatus="pool">
									<c:if test="${comm.blacklist == null }">
										...
										<td>
											<button onclick="popupwindow('management/addBlackForGoods?id=${comm.commCode }&mathed=add&page=goods');">加入黑名单</button></td>
										</tr>
									</c:if>
								</c:forEach>
							</tbody>
