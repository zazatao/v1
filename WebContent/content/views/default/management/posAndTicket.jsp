		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<span class="divider"><font style="font-size: 18px;">/</font></span>
					<li><font style="font-size: 18px;">职位与票</font></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div class="panel panel-default">
					...
					<div class="list-group-item">
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="posAndDep" items="${list }" varStatus="pool">
									<c:choose>
									...
									<td>${posAndDep.id}</td>
									<td>${posAndDep.department.departmentname}</td>
									<td>${posAndDep.positions.positionname}</td>
									<td>${posAndDep.ticket.ticketName}</td>
									<td>${posAndDep.wage}</td>
									<td>${posAndDep.rules}</td>
									<td>${posAndDep.saleCut}</td>
									<td><button class="btn btn-default" onclick="popupwindow('management/updatePosAndTicket?id=${posAndDep.id}');">修改规则和票</button>
									</tr>
								</c:forEach>
							</tbody>
						</table>
