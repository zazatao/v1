		...
		<div class="dlzc">
			<ul>
				...
				<li style="background: #fff; height: 32px; margin-top: 1px;"><a
					style="color: #000;" href="./proscenium/shopcar" id="buyCatNum">
					<c:if test="${sessionScope.language == 'chinese' }">购物车(0)</c:if>
					<c:if test="${sessionScope.language == 'russina' }">МОЯ КОРЗИНА</c:if>
					</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		...
		<div class="menu">
			...
			<div class="menu1">
				<ul class="navf" id="navShopCaegory1">
					<li class="bg_none" ><a style="width:40px;" href="./index"><img
					...
					<c:forEach items="${shopCategories }" var="shopCategory">
						<c:if test="${shopCategory.level == 1 && shopCategory.category != '汽车用具' && shopCategory.category != '电子产品' }">
							<li >
							<a style=" width:85px;" href="./proscenium/categoryOne?id=${shopCategory.categoryID}">
