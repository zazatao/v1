...
<body>
				...
				<form class="form-horizontal"  id="form" name="form" method="POST">
					<div class="form-group">
						<c:if test="${mathed == 'add'}">
							<label for="inputEmail3" class="col-sm-2 control-label">填写类型</label>
							<input type="hidden" name="id" value="${id }">	
							<div class="col-sm-8">
							<input id="type"  class="form-control" name="type">${material.type}
							</div>	
						</c:if>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input id="standard"  class="form-control" name="standard" value="${material.standard}">
						</div>
					</div>	
	...
	<script type="text/javascript">
		...
		function addMaterial(obj){
			document.form.action="shop/addMaterialList?page=${page}&mathed="+obj;
