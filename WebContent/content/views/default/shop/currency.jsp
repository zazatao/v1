...
<body >
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							币种列表
							<a href="#" onclick="popupwindow('./addCurrency?mathed=add');">
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="currency" items="${currencylist }" varStatus="pool">
									...
									<td><button class="btn btn-default" onclick="popupwindow('addCurrency?id=${currency.id}&mathed=update');">修改</button>
	...
	<script type="text/javascript">
		function deleteCurrencyById(obj){
 			location.href = "deleteCurrency?id="+obj;
		}
