...
<body >
		...
		<div class="row-fluid">
			<div class="span12">
				<ul class="breadcrumb">
					...
					<span class="divider"><font style="font-size: 18px;">/</font></span>
					<li><font style="font-size: 18px;">币种</font></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							币种列表
							<a href="javascript:void(0);" onclick="popupwindow('shop/addCurrency?mathed=add');">
						...
						<table class="table table-striped">
							...
							<tbody>
								<c:forEach var="currency" items="${currencylist }" varStatus="pool">
									...
									<td><button class="btn btn-default" onclick="popupwindow('shop/addCurrency?id=${currency.id}&mathed=update');">修改</button>
										<button class="btn btn-default" onclick="deleteCurrencyById('${currency.id}');" >删除</button>
									</td>
								</c:forEach>
							</tbody>
						</table>
	...
	<script type="text/javascript">
		function deleteCurrencyById(obj){
 			location.href = "shop/deleteCurrency?id="+obj;
		}
