...
<body>
	...
	<div class="panel panel-default" style="padding: 0; margin-top: 32px;">
		<div class="panel-heading">
			<h3 class="panel-title">
				<a href="#" style="font-size: 18px;">总览</a> <span class="divider"><font
					style="font-size: 18px;">/</font></span> <font style="font-size: 18px;">未完成订单</font>
			</h3>
		</div>
	</div>
	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				<form class="form-horizontal" action="overall/searchShopOrder?page=overAll"
					method="POST">
	...
	<script type="text/javascript">
		function updateShopOrder(num){
			location.href =	'overall/updateShopOrder?id='+num;
		}
		function deleteShopOrder(num){
			location.href =	'overall/deleteShopOrder?id='+num;
		}
