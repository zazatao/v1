			...
			<div class="shopcartab">
				<div class="shopcartabt1">
					...
					<div class="shcatbtis">
						...
						<div class="shctlink"></div>
						<div class="sctblpri">
							<fmt:formatNumber value="${shopCar.shopCommoidty.currency.symbol }${shopCar.shopCommoidty.unitPrice }" type="currency" pattern="#,###.00#"/> <br />
							<c:if test="${shopCar.shopCommoidty.isSpecial }">
								<fmt:formatNumber value="${shopCar.shopCommoidty.currency.symbol }${shopCar.shopCommoidty.unitPrice * shopCar.shopCommoidty.special}" type="currency" pattern="#,###.00#"/> 
							</c:if>
							<c:if test="${!shopCar.shopCommoidty.isSpecial }">
								<fmt:formatNumber value="${shopCar.shopCommoidty.currency.symbol }${shopCar.shopCommoidty.unitPrice }" type="currency" pattern="#,###.00#"/> 
							</c:if>
						</div>
						<div class="shctlink"></div>
						<div class="sctblapw">
