...
<div class="con"><!---------------   页面主体   ----------------------->
     ...
     <div class="kd">
        <div class="kd_right">
            ...
            <ul>
            	<li><span>选择开店类型：</span><input type="radio" name="1" checked="checked" />个人开店<input type="radio" name="1" />企业开店</li>
                <li><span>选择所在地：</span><input type="radio" name="2" checked="checked" />中国大陆<input type="radio" name="2" />香港/澳门<input type="radio" name="2" />台湾<input type="radio" name="2" />海外</li>
                ...
                <li>
                	<table>
                        ...
                        <tr><td><img src="../content/static/images/small/kd_3.png" />未通过</td><td>zazatao实名认证</td><td><a href="kd_yz.html">重新认证</a></td></tr>
                        <tr><td><img src="../content/static/images/small/kd_4.png" />未开始</td><td>开店认证</td><td><a href="#">立即认证</a></td></tr>
                    </table>	
                </li>
            </ul>
           <div class="cj"><a href="perscent.html"><img src="../content/static/images/small/kd_7.png" width="122" height="37" /></a></div>
        </div>
     </div>
</div>
