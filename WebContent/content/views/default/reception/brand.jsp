...
<body>
	...
	<div class="con">
		...
		<div class="cont_gr3">
			<div class="nybtl">
				<span style="font-weight: bold;font-size: 30px;">品牌</span>
				<div class="clear"></div>
			...
			<p class="cont_gr3_sort">
				<a href="../proscenium/categoryLei?id=-1&page=brand">所有分类*</a><a
					...
					href="../proscenium/categoryLei?id=1&page=brand">男士*</a><a
					href="../proscenium/categoryLei?id=58&page=brand">儿童*</a> <a
					href="../proscenium/categoryLei?id=62&page=brand">运动*</a><a
					href="../proscenium/categoryLei?id=30&page=brand">电子产品*</a><a
					href="../proscenium/categoryLei?id=60&page=brand">居家*</a><a
					href="../proscenium/categoryLei?id=7&page=brand">箱包*</a>
			</p>
				  ...
				  <c:choose>
					<c:when test="${not empty shopcomlist }">
						<c:forEach items="${shopcomlist}" var="shopcom">
							<dl class="border_gray" style="float: left;">
								<dt>
								...
								<dd>
									<a
										href="../proscenium/shopCommItem?id=${shopcom.brand.brandID }&page=brand&which=brand"><img
										src="..${shopcom.brand.logo}"></a>
								</dd>
								<dd>
