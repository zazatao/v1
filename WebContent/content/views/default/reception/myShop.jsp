    	...
    	<div class="catelist">
        	<div>
                ...
                <ul>
                  ...
                  <li><a href="#">已售完<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">留言/回复<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">出售中<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">仓库中<span class="gay">(${marriage})</span></a></li>
                </ul>
        	...
        	<div>
            	<p>交易</p>
                <ul>
                  <li><a href="#">待买家付款<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">待发货<span class="gay">(${marriage})</span></a></li>                 
                  <li><a href="#">留言/回复<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">待买家收货<span class="gay">(${marriage})</span></a></li>
                  <li><a href="#">退货退款<span class="gay">(${marriage})</span></a></li>
