...
<body>
	...
	<div class="con">
		...
		<div class="perterrtab">
			<h3>
				7天内店铺交易访问情况：<span><a href="#">查看详细图表</a></span>
			</h3>
			<div>
		...
		<div class="perterrcont">
			...
			<p>
				<img style="CURSOR: pointer"
					onclick="javascript:window.open('http://b.qq.com/webc.htm?new=0&sid=800025375&o=zzt&q=7', '_blank', 'height=502, width=644,toolbar=no,scrollbars=no,menubar=no,status=no');"
					border="0" SRC="../content/static/images/brand/perterrcont1.jpg"
					alt="点击这里给我发消息"> 企业QQ(800025375)/在线时间<a href="#">08:00-23:30</a>
			</p>
			<span><img
				src="../content/static/images/brand/perterrcont3.jpg" /><img
				src="../content/static/images/brand/perterrcont2.jpg" /></span>
		</div>
	</div>
