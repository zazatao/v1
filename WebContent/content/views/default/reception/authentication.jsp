...
<body>
	...
	<div class="con">
		<!---------------   页面主体   ----------------------->
		<div class="dqwz">
			<a href="../index">zazatao</a>> <a href="../proscenium/setUpShop">免费开店</a>
			><a href="../proscenium/authentication">重新验证</a>
		</div>
		<div class="kd_yz">
			<h1>
				<img src="../content/static/images/small/kd_5.png" />
			</h1>
			<h2>
				<span class="orange">设置身份信息</span><span style="margin-left: 230px;">设置支付方式</span><span
					style="margin-left: 250px;">成功</span>
			</h2>
			<div class="kd_yz_cont">
				<dl>
					<dt class="dt_1">为了给你提供更好的支付和金融服务，你需要填写真实的身份信息享受会员保障服务。身份信息一经录入不可更改，隐私信息未经本人许可严格保密。</dt>
					<dd>
						账户名:<b>${user.loginName }</b>
					</dd>
				</dl>
				<c:if test="${not empty msg }">密码输入错误</c:if>
				<form action="./authentication" method="post">
					<dl>
						<dt>
							<span class="orange"><b>设置登录密码</b></span><span class="gray">登录时需验证，保护账户信息</span>
						</dt>
						<dd>
							<span>登录密码</span><input type="password" value="" name="pwd" />
						</dd>
						<dd>
							<span>再一次输入密码</span><input type="password" value=""
								name="password" />
						</dd>
					</dl>
					<dl>
						<dt>
							<span class="orange"><b>设置支付密码</b></span><span class="gray">交易付款或账户信息更改时需输入，与登录密码不一样，安全级别更高</span>
						</dt>
						<dd>
							<span>支付密码</span><input type="text" value="" name="payPassword" />
						</dd>
						<dd>
							<span>支付密码</span><input type="text" value="" name="payPwd" />
						</dd>
					</dl>
					<dl>
						<dt>
							<span class="orange"><b>设置身份信息</b></span><span class="gray">请务必准确填写本人的身份信息，注册后不能更改，隐私信息未经本人许可严格保密

								若您的身份信息和快捷支付身份信息不一致，将会自动关闭已开通的快捷支付服务。</span>
						</dt>
						<dd>
						...
						<dd>
							<span>身份证号码</span><input type="text" value="" name="idCard" />
						</dd>
						<dd>
							<span></span><input type="checkbox" class="check" />我同意zazatao服务协议
						</dd>
						<dd>
							<span></span><input type="submit" class="kd_bot" value="确定" />
						</dd>
					</dl>
				</form>
			</div>
