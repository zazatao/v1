			...
			<div class="nei">
				<div class="nei01">
					<table width="760" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="2"><div align="left">
									成交时间：从 <input type="text" name="textfield9" id="textfield9"
										style="width: 75px;" placeholder="年-月-日" />&nbsp;&nbsp;<input
										type="text" name="textfield10" id="textfield10"
										onclick="timessss('textfield10');" style="width: 45px;"
										placeholder="时：分" /> 到 <input type="text" placeholder="年-月-日"
										name="textfield11" id="textfield11" style="width: 75px;" /> <input
										type="text" placeholder="时：分" name="textfield12"
						...
						<tr>
							<td height="30"><div align="left">
									买家昵称： <input type="text" name="textfield2" id="textfield2" />
								</div></td>
							<td><div align="left">
									订单状态： <select name="textfield5" id="textfield5"
										placeholder="状态">
										<option value="">-----状态-----
									...
									<div class="pro">
										<table width="770" border="0" align="center" cellpadding="0"
											...
											<c:forEach items="${list }" var="order">
													<tr style="background-color: #BBFFEE;"><td colspan="3">订单编号：${order.orderFormID }</td><td ><div align="center">${order.deliveryMoney }</div></td>
													<td colspan="4"></td></tr>
												<c:forEach items="${order.commodities }" var="comm">
													<tr>
														<c:if test="${comm == null }"><td height="30" colspan="5">没有符合条件的商品，请尝试其他搜索条件。</td></c:if>
														...
														<td><div align="center">
															<c:choose>
																...
																<c:when test="${order.orderstatus == 'refundOrderForm' }">退款订单</c:when>
																...
																<c:when test="${order.orderstatus == 'autoCloseTransaction' }">自动关闭交易</c:when>
															</c:choose>
															</div></td>
									...
									<div class="pro">
										...
										<table width="760" border="0" align="center" cellpadding="0"
											...
											<tr>
												...
												<td width="70" bgcolor="#EEEEEE"><div align="center">批量免运费</div></td>
								...
								<div class="TabContent" id="myTab1_5"
									...
									<div class="pro">
										<table width="770" border="0" align="center" cellpadding="0"
											...
											<c:forEach items="${list }" var="order">
												<c:if test="${order.orderstatus == 'completionTransaction' }">
												<tr style="background-color: #BBFFEE;"><td colspan="3">订单编号：${order.orderFormID }</td><td ><div align="center">${order.deliveryMoney }</div></td>
													<td colspan="4"></td></tr>
													<c:forEach items="${order.commodities }" var="comm">
														<tr>
								...
								<div class="TabContent" id="myTab1_6"
									...
									<div class="pro">
										<table width="770" border="0" align="center" cellpadding="0"
											...
											<c:forEach items="${list }" var="order">
												<c:if test="${order.orderstatus == 'closeTransaction' || order.orderstatus == 'autoCloseTransaction'}">
													<tr style="background-color: #BBFFEE;"><td colspan="3">订单编号：${order.orderFormID }</td><td ><div align="center">${order.deliveryMoney }</div></td>
													<td colspan="4"></td></tr>
													<c:forEach items="${order.commodities }" var="comm">
														<tr>
